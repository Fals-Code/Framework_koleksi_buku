            ...
            <div class="card-body p-4">
                <form action="{{ route('customer.store1') }}" method="POST" id="customerForm">
                    ...
                    <div class="row">
                        <!-- Form Inputs -->
                        <div class="col-md-6">
                            <h5 class="fw-bold mb-4 text-primary">Informasi Personal</h5>
                            ...
                            <button type="submit" class="btn btn-gradient-primary btn-lg w-100 fw-bold shadow-sm rounded-pill py-3 mt-3">
                                <i class="mdi mdi-content-save me-2"></i> SIMPAN DATA CUSTOMER
                            </button>
                        </div>

                        <!-- Camera Section -->
                        <div class="col-md-6">
                            <h5 class="fw-bold mb-4 text-primary">Ambil Foto Customer</h5>
                            <div class="camera-container shadow-sm border">
                                ...
                                <p class="small text-muted mt-3 mb-0" id="camera-status">Kamera belum aktif</p>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    btnStart.addEventListener('click', async () => {
        try {
            ...
            statusText.innerText = 'Kamera Aktif - Siap mengambil foto';
        } catch (err) {
    ...
    btnCapture.addEventListener('click', () => {
        ...
        // Mirror the canvas for capture if needed (matches preview)
    ...
    btnRetake.addEventListener('click', () => {
        ...
        btnCapture.style.display = 'inline-block';
        inputBase64.value = '';
        statusText.innerText = 'Kamera Aktif kembali';
    ...
    form.addEventListener('submit', (e) => {
        if (!inputBase64.value) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Foto Wajib!',
                text: 'Silakan ambil foto customer terlebih dahulu.'
            });
        }
    });
</script>
